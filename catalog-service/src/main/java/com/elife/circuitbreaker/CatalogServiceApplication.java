package com.elife.circuitbreaker;

import com.elife.circuitbreaker.entity.Order;
import com.elife.circuitbreaker.repository.OrderRepository;
...
public class CatalogServiceApplication {
    ...
    public void saveOrders() {
        orderRepository.saveAll(Stream.of(
                        new Order("iphone", "electronics", "white", 20000),
                        new Order("Shirt", "clothes", "black", 999),
                        new Order("Cotton Jeans", "clothes", "blue", 1999),
                        new Order("DELL", "electronics", "gray", 50000)
                ).
                collect(Collectors.toList()));
    }
